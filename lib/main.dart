...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      /*OrientationBuilder(
          //cihazın dikey-yatay konumu ayarlamak için kullanılır.
          builder: (context, orientation) {
        if (orientation == Orientation.portrait) {
          return uygulamaGovdesi();
        } else {
          return uygulamaGovdesiLandscape(orientation);
        }
      }),*/
    );
  }
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Center(
                child: RichText(
                    //stringin bir kısmını farkli bir stille geri kalanı farklı stille yapmak istersek.
  ...
  Widget _listeOlustur(BuildContext context, int index) {
    ...
    Color olusanRastgeleRenk = rasgeleRenkOlustur();

    return Dismissible(
      //eğer bir sutunu soldan sağa doğru kaydırarak silmek istiyorsak kullanılır.
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          subtitle: Text(tumDersler[index].toString() +
  ...
  /*Widget uygulamaGovdesiLandscape(Orientation orientation) {
    return Container(
        child: Row(
